...
function EditNews() {
  ...
  const { singleNews, errors, message, loading } = useSelector(
    ...
    <DashboardLayout>
      ...
      <Card>
        ...
        <MDBox pt={4} pb={3} px={3}>
          <Formik
            initialValues={{
              title: singleNews ? singleNews.title : "",
              description: singleNews ? singleNews.description : "",
            }}
          ...
          >
            {(formik) => (
              <Form>
                <FormInput label="Channel Name" name="title" type="text" />
                <FormInput label="Link" name="description" type="text" />
                <img
                  crossOrigin="true"
                  src={
                    singleNews
                      ? singleNews.photoPath
